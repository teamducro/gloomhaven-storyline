...
export default {
    ...
    methods: {
        update(percentage) {
            ...
            const circle_rotate = document.querySelectorAll('#code-progress .circle-loader-rotate');
            const circle_inner = document.querySelectorAll('#code-progress .circle-loader-circle');
