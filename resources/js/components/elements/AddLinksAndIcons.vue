        ...
        addIcons(text) {
            if (text.includes('{')) {
                collect({
                    ...
                    '{CULTIVATE}'           : '<span class="text-characters-aa">' + this.$t('Cultivate')        + '</span>' + '<webp src="/img/icons/status/cultivate.png" width="20" class="inline"/>',
                    '{DEATHSHROUD_SPIDER}'  : '<span class="text-characters-aa">' + this.$t('Deathshroud')      + '</span>' + '<webp src="/img/icons/status/deathshroud.png" width="20" class="inline"/>',
                    '{FIRESPITTER_ANT}'     : '<span class="text-characters-aa">' + this.$t('Firespitter')      + '</span>' + '<webp src="/img/icons/status/firespitter.png" width="20" class="inline"/>',
                    '{GHOST_SHIMMER_BEE}'   : '<span class="text-characters-aa">' + this.$t('Ghostshimmer')     + '</span>' + '<webp src="/img/icons/status/ghostshimmer.png" width="20" class="inline"/>',
                    '{GLOW}'                : '<span class="text-characters-lu">' + this.$t('Glow')             + '</span>' + '<webp src="/img/icons/status/glow.png" width="20" class="inline"/>',
                    '{LADDER}'              : '<span class="text-characters-fk">' + this.$t('Ladder')           + '</span>' + '<webp src="/img/icons/status/ladder.png" width="20" class="inline"/>',
                    '{MOUNT}'               : '<span class="text-characters-ct">' + this.$t('Mount')            + '</span>' + '<webp src="/img/icons/status/mount.png" width="20" class="inline"/>',
                    '{PROJECTILE}'          : '<span class="text-characters-bm">' + this.$t('Projectile')       + '</span>' + '<webp src="/img/icons/status/projectile.png" width="20" class="inline"/>',
                    '{ROCKSPINE_TERMITE}'   : '<span class="text-characters-aa">' + this.$t('Rockspine')        + '</span>' + '<webp src="/img/icons/status/rockspine.png" width="20" class="inline"/>',
                    '{SCRAP}'               : '<span class="text-characters-qa">' + this.$t('Scrap')            + '</span>' + '<webp src="/img/icons/status/scrap.png" width="20" class="inline"/>',
                    '{SCRAP_X}'             : '<span class="text-characters-qa">' + this.$t('ScrapX')           + '</span>' + '<webp src="/img/icons/status/scrapX.png" width="20" class="inline"/>',
                    '{SHACKLE}'             : '<span class="text-characters-cg">' + this.$t('Shackle')          + '</span>' + '<webp src="/img/icons/status/shackle.png" width="20" class="inline"/>',
                    '{SPIRIT}'              : '<span class="text-characters-sp">' + this.$t('Spirit')           + '</span>' + '<webp src="/img/icons/status/spirit.png" width="20" class="inline"/>',
                    '{VOID}'                : '<span class="text-characters-ho">' + this.$t('Void')             + '</span>' + '<webp src="/img/icons/status/void.png" width="20" class="inline"/>',
                    '{VOID_X}'              : '<span class="text-characters-ho">' + this.$t('VoidX')            + '</span>' + '<webp src="/img/icons/status/voidX.png" width="20" class="inline"/>',
