    ...
    quest: {
        ...
        3: {
            ...
            "sections": {
                ...
                4: "Vous avez occis Jekserah. Il est l'heure de ramener la tête de votre ancien patron au repaire des cultistes.",
                5: "Malheureusement pour les cultistes, vous avez décidé de prendre le parti de Jekserah en prenant possession de la ville. Votre mystérieux contact ne voudra probablement plus jamais vous rencontrer.",
                6: "Vous avez rencontré la silhouette masquée au repaire du culte, où elle vous a remercié pour votre aide contre la nécromancienne. Il vous a ensuite présenté à une déchirure dans l'espace, noire et enflammée, qu'il a appelé son maitre : l'Ombre. La silhouette vous a alors trahis en invocant une horde de créatures surnaturelles pour vous tuer. Apparamment, il est difficile d'entrer dans les bonnes grâces du culte après avoir assassiné leurs membres et contrarié leurs plans. Après une bataille éprouvante, l'Ombre vous a parlé d'une voix froide et grave : 'Vous vous êtes bien défendus. Mes serviteurs ne sont peut-être pas capable de vous pardonner, mais moi je le peux. Venez. Rejoignez-moi. Entre dans mon royaume. Embrassez votre inéluctable destinée.' La faille se tient devant vous. Oserez-vous entrer ?",
