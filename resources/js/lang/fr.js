export default {
    ...
    "No items found": "Objet non trouvé",
    ...
    "scenarios": {
        ...
        "Inox Encampment": "Le Campement Inox",
        "Crypt of the Damned": "La Crypte des Damnés",
        "Ruinous Crypt": "La Crypte dans les Ruines",
        "Decaying Crypt": "La Crypte en Déclin",
        "Vibrant Grotto": "La Grotte foisonnante",
        "Gloomhaven Warehouse": "L'Entrepôt de Havrenuit",
        "Diamond Mine": "La Mine de Diamant",
        "Plane of Elemental Power": "La Dimension du Pouvoir Elementaire",
        "Gloomhaven Square A": "La Place de Havrenuit A",
        "Gloomhaven Square B": "La Place de Havrenuit B",
        "Temple of the Seer": "Le Temple du Prophète",
        "Frozen Hollow": "La Caverne Gelée",
        "Shrine of Strength": "Le Sanctuaire de Puissance",
        "Mountain Pass": "Le Col de la Montagne",
        ...
        "Echo Chamber": "La Chambre des Echos",
        "Icecrag Ascent": "L'Ascension du Rideau de Glace",
        "Ancient Cistern": "L'Ancienne Citerne",
        "Ruinous Rift": "La faille dans les Ruines",
        "Outer Ritual Chamber": "La Chambre du Rituel de l'Outre-Monde",
        "Sanctuary of Gloom": "Le Sanctuaire de l'Ombre",
        "Shrine of the Depths": "Le Mausolée des Profondeurs",
        "Plane of Night": "La Dimension de la Nuit",
        "Decrepit Wood": "Le Bois Abandonné",
        "Savvas Armory": "L'Armurerie Savvas",
        "Scorched Summit": "Le Sommet Calciné",
        "Gloomhaven Battlements A": "Les Remparts de Havrenuit A",
        "Gloomhaven Battlements B": "Les Remparts de Havrenuit B",
        "Doom Trench": "La Tranchée de l'Ombre",
        "Slave Pens": "L'Enclos des Esclaves",
        "Treacherous Divide": "Le Précipice Périlleux",
        "Ancient Defense Network": "L'Ancien Réseau de Défense",
        "Timeworn Tomb": "Le Tombeau Erodé",
        "Realm of the Voice": "Le Royaume de la Voix",
        "Drake Nest": "Le Nid des Wyvernes",
        "Tribal Assault": "Assaut Tribal",
        "Rebel Swamp": "Le Marais des Rebelles",
        "Nightmare Peak": "Le Pic des Cauchemars",
        "Lair of the Unseeing Eye": "L'Antre de l'Oeil Aveugle",
        "Shadow Weald": "La Forêt Lugubre",
        "Rebels Stand": "Le Campement des Rebelles",
        "Ghost Forrest": "La Forteresse Fantôme",
        "The Void": "Le Néant",
        "Noxious Cellar": "La Cave Toxique",
        "Crypt Basement": "Le Sous-sol de la Crypte",
        "Palace of Ice": "Le Palais de Glace",
        "Foggy Thicket": "Le fourré Brumeux",
        "Bandits Wood": "Le Bois du Bandit",
        "Investigation": "Enquête",
        "Bloody Shack": "La Planque Ensanglantée",
        "Forgotten Grove": "Le Bosquet Oublié",
        "Alchemy Lab": "Le laboratoire d'Alchimie",
        "Fading Lighthouse": "Le Phare Evanescent",
        "Pit of Souls": "La fosse des Ames",
        "Magma Pit": "Le Cratère de Magma",
        "Under Water Lagoon": "Le Lagon Sous-marin",
        "Sulfur Mine": "La Mine de Soufre",
        "Clockwork Cove": "La Crique Mécanique",
        "Arcane Library": "La Bibliothèque Arcanique",
        "Toxic Moor": "La Lande Toxique",
        "Well of the Unfortunate": "Le Puits de l'Infortuné",
        "Chained Isle": "L'Ile Enchaînée",
        "Windswept Highlands": "Les Plateaux Venteux",
        "Oozing Grove": "Le Bosquet Suintant",
        "Rockslide Ridge": "La Crête de l'Eboulement",
        "Merchant Ship": "Le Navire Marchand",
        "Overgrown Graveyard": "Le Cimetière en friche",
        "Harrower Hive": "La Ruche des Persécuteurs",
        "Vault of Secrets": "Le Caveau des Secrets",
        "Sacrifice Pit": "Le fossé Sacrificiel",
        "Lost Temple": "Le Temple Perdu",
        "Vigil Keep": "La Forteresse de la Vigie",
        "Temple of the Eclipse": "Le Temple de lEclipse",
        "Burning Mountain": "La Montagne Ardente",
        "Shadows Within": "Les Ombres Intérieures",
        "Crystalline Cave": "La Grotte Cristalline",
        "Sun Temple": "Le Temple Solaire",
        "Harried Village": "Le Village Tourmenté",
        "Corrupted Cove": "La Crique Corrompue",
        "Plane of Water": "La Dimension de l'Eau",
        "Syndicate Hideout": "La Planque du Syndicat",
        "Demonic Rift": "La faille Démoniaque",
        "Wild Melee": "La Mêlée Sauvage",
        "Back Alley Brawl": "Bagarre dans l'Arrière-cour",
        "Sunken Vessel": "Le Vaisseau Englouti",
        "Vermling Nest": "Le Nid des Vermlings",
        "Payment Due": "L'Heure du Jugement"
    },
    "achievements": {
    ...
    "quest": {
        "1": {
            ...
            "sections": {
                ...
                "3": "Vous avez vaincu le Chef des bandits. Mais il y avait quelque chose dans son regard qui ne semblait pas naturel et il a mentionné l'Ombre pendant votre bataille. Vous avez trouvé les parchemins volés, cachés dans la chambre du Chef et les avez rendus à Jekserah en échange de la récompense convenue."
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
        ...
        "12": {
            ...
            "sections": {
                "1": "Un de vos contacts au Sanctuaire du Grand Chêne connait un temple dédié à une force invisible qui répondra à toutes les questions qui lui seront posées. C'est une occasion en or de trouver ce que désire votre cœur.",
                "2": "Lorsque vous avez finalement atteint le temple, une Voix vous a dit ” Je ne peux pas accepter de visiteurs pour le moment ”. Avant de pouvoir vous y opposer, un groupe de golem de pierre s'est matérialisé devant vous. Mais il n'y avait aucun moyen que vous vous en alliez les mains vides. Après en avoir fini avec les monstres, la Voix vous a ensuite offert un choix entre une grande puissance, une grande richesse ou l'emplacement du nécromancien. ",
                "3": "Le choix évident était un grand pouvoir. Vous n'êtes pas intéressé par l'or ou par de petites vengeances. La seule chose qui compte, c'est la capacité de mettre en œuvre votre volonté. La Voix vous a parlé d'un sanctuaire dans les Crêtes de Cuivre qui contient une source de grande Puissance.",
                "4": "Quel genre de mercenaire seriez-vous si vous n'étiez pas payé? Une grande richesse est le choix évident ici. La Voix vous a parlé d'une île perdue dans la Mer de Brume qui contient des trésors oubliés depuis longtemps.",
                "5": "Le pouvoir et la richesse ne signifient rien pendant que Jekserah respire encore. Vous insistez pour que la Voix vous indique l'emplacement de la néfaste Valrath. Elle vous a parlé d'un sanctuaire caché au fond du Bois du Cadavre."
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}{3}",
        ...
        "15": {
            ...
            "sections": {
                "1": "Vous avez entendu parler de grandes créatures volantes dans les Crêtes de Cuivre. Pourrait-il y avoir vraiment des dragons dans les montagnes ? Cela vaut la peine d'être étudié, les dragons pourraient représenter une menace sérieuse pour la ville.",
                "2": "Votre objectif est le Rideau de Glace, la plus haute montagne des Crêtes de Cuivre. Sur votre chemin, vous avez été pris en embuscade par un groupe d'Inox et de démons. Leur coexistence était curieuse, mais votre objectif ultime est plus loin.",
                "3": "L'ascension de la glace a été exténuante et ardue. Vous avez dû vous battre contre le froid, les loups et un nid de Wyvernes en colère. Cependant, vous avez atteint le fond de cette affaire de dragon. Au sommet du sommet se trouvait un lézard ailé gigantesque - qui pouvait parler. Il parlait d'une voix rocailleuse qui vous a surpris par son éloquence. En fait, il a demandé votre aide. “Un groupe de Savvas m'a attaqué dans mon sommeil et a enlevé une de mes glandes de flammes, vraisemblablement pour l'étudier. Je ne peux pas laisser cette insulte impunie et j'apprécierais grandement que vous la retiriez de leur ville, tuant autant d'entre eux que possible dans le processus. Ou, si vous souhaitez coller au cliché ”, dit la créature en soupirant, ” vous pouvez simplement m'attaquer. Tuer le dragon, sauver la princesse, et tout ça. Sauf que je n'ai pas de princesse, et je ne suis pas un dragon - juste un Wyverne qui a vécu longtemps et ne souhaite pas mettre fin à ses jours aujourd'hui. Donc, si vous m'attaquez, je riposterai et vous mourrez assurément. ”"
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
        ...
        "16": {
            ...
            "sections": {
                "1": "Vous avez entendu parler d'une île inconnue de la mer de Brume qui contiendrait de vastes richesses. Il est temps de louer un bateau.",
                "2": "L'île était infestée de Vermlings sauvages. Cependant, aucun Vermling ne peut se tenir entre vous et un trésor. Vous avez pris d'assaut l'île et découvert les restes d'un navire abandonné dans lequel les Vermlings se réfugiaient. Le navire contenait une pléthore d'or ; Qui sait ce que les Vermlings pouvaient faire de cet or ? Vous avez en tout cas une bonne idée de l'utilisation que vous en ferez."
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}"
        ...
        "17": {
            ...
            "sections": {
                "1": "L'approvisionnement en eau de Havrenuit semble avoir été empoisonné. On vous a demandé d'enquêter sur la source du poison. Malheureusement, cela signifie marcher péniblement dans les égouts. Beurk.",
                ...
                "3": "Vous avez rencontré l'enchanteresse Esther, Tourmente, à l'Os Tordu. Bien qu'un peu excentrique, elle semble tout à fait compétente. Vous avez gagné sa faveur en l'aidant dans ses quêtes. Peut-être qu'elle peut maintenant vous aider à trouver un moyen de respirer sous l'eau ?",
                "4": "Vous avez trouvé un chemin vers la source du poison. Il est temps de purifier l'eau.",
                "5": "Les pompes à eau grouillaient de créatures impies et d'une corruption noire. Au moment où le combat s'est terminé, les murs et le sol étaient couverts de suintement noir, mais vous avez réussi à tout sortir des pompes. Elles ne vibrent plus, ce qui est un pas dans la bonne direction. Une simple patrouille pourra nettoyer les restes, maintenant que la présence sombre a été supprimée. "
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
        ...
        "19": {
            "name": "Exorcisme",
            "sections": {
                "1": "Dans la faille entre les royaumes, vous avez rencontré un puissant démon. {Br} L'attaquer dans son propre royaume sera difficile, mais il est temps qu'il périsse.",
                "2": "La faille a été neutralisée avant que vous puissiez affronter le démon dans son palais.",
                "3": "Attaquer un démon dans son propre royaume a peut-être été un peu téméraire. Le démon était invulnérable, mais vous avez réussi à briser un autel de verre noir qui semblait contenir l'essence du démon. Avec sa destruction, le démon majeur s'est brisé en d'innombrables éclats de pierre. "
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
        ...
        "22": {
            ...
            "sections": {
                "1": "Les Inox et les démons que vous avez rencontrés sur le chemin du Rideau de Glace avaient des inscriptions grossières mentionnant une ” Voix ” parmi leurs affaires. Il y avait une grotte à proximité du col de la Montagne qui semblait vous appeler. Vous vous sentez une envie subtile et puissante d'explorer la grotte. ",
                "2": "La grotte contient une créature puissante, connue uniquement sous le nom de ” La Voix ”. Elle vous demande de l'aider à se libérer de l'esclavage, mais les motifs de La Voix restent incertains. "
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}"
        ...
        "24": {
            ...
            "sections": {
                "1": "Il y a quelque chose de profondément préoccupant à propos de l'artefact que vous avez récupéré dans le Temple des Éléments. Vous ressentez une obscurité puissante émanant de la chose, et derrière cela, une profonde tristesse. Cet artefact a été corrompu, et il semble presque être conscients de ce fait. Peut-être serait-il préférable de l’apporter à un enchanteur plutôt que de jouer avec. ",
                "2": "Vous avez rencontré l'enchanteresse Esther, Tourmente, à l'Os Tordu. Bien qu'un peu excentrique, elle semble tout à fait capable. Vous avez gagné sa faveur en l'aidant dans ses quêtes. Cependant, vous avez remis l'artefact au démon majeur. Si vous voulez que Tourmente l'inspecte, vous devrez le récupérer. Il ne voudra probablement pas s'en séparer de bon cœur. ",
                "3": "Un enchanteur pourrait peut-être vous en dire plus sur l'artefact. Cependant, vous avez remis l'artefact au démon majeur. Si vous voulez que l'enchanteur l'inspecte, vous devrez le récupérer du démon. Il ne voudra probablement pas s'en séparer de bon cœur.",
                "4": "Vous avez rencontré l'enchanteresse Esther, Tourmente, à l'Os Tordu. Bien qu'un peu excentrique, elle semble tout à fait capable. Vous avez gagné sa faveur en l'aidant dans ses quêtes. Peut-être qu'elle peut maintenant vous en dire plus sur l'artefact ? ",
                "5": "Tourmente a souligné que l'artefact était corrompu. Elle vous a envoyé plutôt brusquement dans la Dimension des ténèbres pour rompre l'enchantement de l'artefact. Vous avez réussi à rompre la connexion. De retour dans votre propre plan d'existence, Tourmente a mentionné trois endroits qui puisaient le pouvoir de l'artefact corrompu. Si vous voulez en savoir plus sur l'artefact, vous pouvez visiter ces emplacements. "
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
        ...
        "26": {
            ...
            "sections": {
                "1": "Une créature puissante vous a ordonné de pénétrer dans un arsenal Savvas et de récupérer son trésor. Vous hésitez à pénétrer dans une installation aussi sécurisée, mais l'injonction de la créature est forte.",
                "2": "Vous avez tué la puissante créature, mettant un terme à son influence sur vous. Vous ressentez toujours une envie de pénétrer dans l'armurerie, mais sans ordre direct, vous n'êtes pas assez audacieux pour essayer.",
                "3": "Vous avez tué les deux puissantes créatures, mettant un terme à leurs influences sur vous. Vous n'avez plus aucune envie de pénétrer dans l'armurerie. C'est tout simplement trop fou.",
                "4": "La volonté de la créature a été accomplie. L'arsenal a été pillé et vous possédez ses trésors. Bien qu'il soit peut-être préférable de ne pas montrer votre visage autour de la ville Savvas pendant quelques mois."
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
        ...
        "27": {
            ...
            "sections": {
                "1": "Au sommet du Rideau de Glace, l'Ancienne Wyverne vous a demandé une faveur. N'a-t-elle pas entendu parler de vous ? Vous n'êtes pas en train de négocier avec des lézards. Il est temps de tuer un dragon.",
                "2": "À bien y penser, avoir un dragon dans vos dettes peut s'avérer utile. Vous avez décidé d'aider l'ancienne Wyverne. Après tout, c'était la première Wyverne à ne pas essayer de vous manger.",
                "3": "Vous n'aviez jamais imaginé qu'un 'dragon' serait aussi sournois lorsqu'il est en train de mourir. Malgré ses sarcasmes, la ville vous a plutôt bien payé pour avoir tué l'ancienne Wyverne."
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
        ...
        "28": {
            ...
            "sections": {
                "1": "Vous avez récupéré l'artefact, comme le demandait le démon. Il est tout à fait clair que l'artefact a été corrompu. Si vous apportez cela au démon, il l'utilisera très certainement pour un grand et terrible mal.",
                "2": "Vous avez scellé la faille sans remettre l'artefact au démon. De toute évidence, il ne fallait pas lui faire confiance avec un objet aussi dangereux et puissant.",
                "3": "Vous avez remis l'artefact au démon, mais vous avez rapidement changé d'avis lorsque vous avez réalisé que son plan était de prendre le contrôle de Havrenuit. Vous avez averti les gardes de la ville et les avez aidés à combattre l'invasion des démons.",
        ...
        "29": {
            ...
            "sections": {
                "1": "Vous avez récupéré l'artefact, comme l'a demandé le démon. Il est clair que l'artefact a été corrompu. Si vous apportez cela au démon, il l'utilisera très certainement pour un grand et terrible mal. Mais vous êtes prêt à trahir le démon et à combattre ce mal, quel qu'il soit. ",
                "2": "Pourquoi prendre le risque? Vous avez scellé la faille sans remettre l'artefact au démon. De toute évidence, il ne fallait pas lui faire confiance avec un objet aussi dangereux et puissant.",
                "3": "Après réflexion, l'offre du démon semblait plutôt séduisante. Vous vous êtes rangé du côté du démon, avez massacré la garde de la ville et installé les nouveaux suzerains du démon. Havrenuit est maintenant sous la domination des démons.",
                "4": "Vous saviez que ce serait mauvais ... mais une invasion démoniaque de Havrenuit n'était pas ce que vous aviez en tête. C'était trop pour vous. Vous avez échappé à l'antre du démon et avez couru pour avertir la garde de la ville juste à temps. Les démons ont assailli la porte en nombre, mais vous avez pu tenir assez longtemps pour épuiser le démon principal. Il a réussi à franchir la porte, mais vous l'avez abattu et avez dispersé ses armées. Havrenuit est en sécurité pour l'instant, mais vous voudrez peut-être reconsidérer votre politique consistant à remettre de puissants artefacts à des créatures maléfiques. "
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}",
