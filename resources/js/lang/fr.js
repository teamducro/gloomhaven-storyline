    ...
    quest: {
        ...
        13: {
            ...
            "sections": {
                ...
                1: "À la suite d'une discussion dans le quartier des chaudières, vous avez trouvé l'Esther dans une taverne abandonnée et décrépite: l'Os Tordu. Le nom de la femme Esther est Tourmente et elle semblait un peu excentrique ... peut-être même un peu folle. Après quelques inquiètudes, elle a accepté de vous aider si vous pouviez récupérer une orbe de la Caverne Gelée dans les Crêtes de Cuivre. Les créatures à l'intérieur de la caverne n'étaient pas très heureuses de vous voir, mais vous les avez combattues malgré tout. Le dernier de vos adversaires étant mort, vous vous êtes approché de l'arrière de la chambre, où une petite sphère bleue flottait au-dessus du sol. Vous l'avez cachée dans votre sac à dos et vous êtes retourné à l'os tordu. Tourmente semblait assez appréciative de l'objet. Tourmente a disparu avec la sphère. Après ce qui ressemble à des heures d'attente, elle est revenue et a demandé nonchalamment de faire des expériences sur vous. Vous êtiez un peu surpris, mais elle vous a assuré que c'est tout à fait sûr. De grandes quantités d'or, elle peut désormais améliorer certaines de vos capacités. Plus important encore, elle est également prête à vous faire des faveurs. "
            },
            "stages": {
                0: "{0}",
                1: "{0}{1}"
