    ...
    quest: {
        ...
        12: {
            ...
            "sections": {
                ...
                3: "Quel genre de mercenaire seriez-vous si vous n'étiez pas payé? Une grande richesse est le choix évident ici. La Voix vous parle d'une île perdue dans la Mer de Brume qui contient des trésors oubliés depuis longtemps.",
                4: "Le pouvoir et la richesse ne signifient rien pendant que Jekserah respire encore. Vous insistez pour que la Voix vous indique l'emplacement du néfaste Valrath. Elle vous parle d'un sanctuaire caché au fond du Bois du Cadavre."
            },
            "stages": {
                0: "{0}",
                1: "{0}{1}{2}",
        ...
        17: {
            ...
            "sections": {
                ...
                2: "Vous avez rencontré l'enchanteresse Esther, Tourmente, au Os Tordu. Bien qu'un peu excentrique, elle semble tout à fait capable. Vous avez gagné sa faveur en l'aidant dans ses efforts. Peut-être qu'elle peut maintenant vous aider à trouver un moyen de respirer sous-marin?",
