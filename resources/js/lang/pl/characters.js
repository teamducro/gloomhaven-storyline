export default {
    "BR": {
        ...
        "perks": [
            ...
            "Dodaj dwie karty {+1_WHITE}",
            "Dodaj jedną kartę {+3_WHITE}",
            "Dodaj trzy karty {AGAIN} {PUSH}1",
            "Dodaj dwie karty {AGAIN} {PIERCE}3",
    ...
    "CH": {
        "name": "Skałosercy",
        "perks": [
            "Usuń cztery karty {+0_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE}",
            "Dodaj jedną kartę {-2_WHITE} oraz dwie karty {+2_WHITE}",
            "Dodaj jedną kartę {+1_WHITE} {IMMOBILIZE}",
            "Dodaj jedną kartę {+2_WHITE} {MUDDLE}",
            "Dodaj dwie karty {AGAIN} {PUSH}2",
    ...
    "TI": {
        ...
        "perks": [
            ...
            "Dodaj dwie karty {+1_WHITE}",
            "Dodaj jedną kartę {+3_WHITE}",
            "Dodaj dwie karty {AGAIN} {FIRE}",
            "Dodaj trzy karty {AGAIN} {MUDDLE}",
            "Dodaj jedną kartę {+1_WHITE} {WOUND}",
            "Dodaj jedną kartę {+1_WHITE} {IMMOBILIZE}",
    ...
    "SC": {
        ...
        "perks": [
            ...
            "Dodaj dwie karty {AGAIN} {+1_WHITE}",
            "Dodaj dwie karty {AGAIN} {PIERCE}3",
    ...
    "DS": {
        ...
        "perks": [
            "Usuń dwie karty {-1_WHITE}",
            "Zastąp dwie karty {+0_WHITE} dwiema kartami {+1_WHITE}",
            "Dodaj dwie karty {AGAIN} {+1_WHITE}",
            "Dodaj jedną kartę {+2_WHITE} {MUDDLE}",
    ...
    "EL": {
        ...
        "perks": [
            ...
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE}",
            "Dodaj trzy karty {+0_WHITE} {FIRE}",
            "Dodaj trzy karty {+0_WHITE} {ICE}",
            "Dodaj trzy karty {+0_WHITE} {WIND}",
            "Dodaj trzy karty {+0_WHITE} {EARTH}",
            "Zastąp dwie karty {+0_WHITE} jedną kartą {+0_WHITE} {FIRE} i jedną kartę {+0_WHITE} {EARTH}",
            "Zastąp dwie karty {+0_WHITE} jedną kartą {+0_WHITE} {ICE} i jedną kartę {+0_WHITE} {WIND}",
    ...
    "SB": {
        ...
        "perks": [
            ...
            "Usuń cztery karty {+0_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE}",
            "Dodaj jedną kartę {AGAIN} {+2_WHITE}",
            "Dodaj jedną kartę {+1_WHITE} {IMMOBILIZE}",
    ...
    "SS": {
        ...
        "perks": [
            ...
            "Zastąp dwie karty {+1_WHITE} jedną kartą {+4_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {IMMOBILIZE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {DISARM}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {WOUND}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {POISON}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {CURSE}",
    ...
    "NS": {
        ...
        "perks": [
            "Usuń dwie karty {-1_WHITE}",
            "Usuń cztery karty {+0_WHITE}",
            "Dodaj jedną kartę {-1_WHITE} {DARK}",
            "Zastąp jedną kartę {-1_WHITE} {DARK} jedną kartą {+1_WHITE} {DARK}",
            "Dodaj jedną kartę {+1_WHITE} {INVISIBLE}",
            "Dodaj trzy karty {AGAIN} {MUDDLE}",
            "Dodaj dwie karty {AGAIN} {HEAL}1",
            "Dodaj dwie karty {AGAIN} {CURSE}",
            "Dodaj jedną kartę {AGAIN} {TARGET}",
    ...
    "BE": {
        ...
        "perks": [
            ...
            "Usuń cztery karty {+0_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {AGAIN} {+2_WHITE}",
            "Dodaj dwie karty {AGAIN} {WOUND}",
            "Dodaj jedną kartę {AGAIN} {STUN}",
    ...
    "PH": {
        ...
        "perks": [
            ...
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE}",
            "Dodaj dwie karty {+1_WHITE}",
            "Dodaj jedną kartę {+1_WHITE} {WIND}",
            "Dodaj trzy karty {AGAIN} {POISON}",
            "Dodaj dwie karty {AGAIN} {CURSE}",
            "Dodaj dwie karty {AGAIN} {IMMOBILIZE}",
            "Dodaj jedną kartę {AGAIN} {STUN}",
    ...
    "BS": {
        ...
        "perks": [
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {+0_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {WOUND}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {POISON}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {WIND}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {EARTH}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {LIGHT}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {DARK}",
            "Dodaj jedną kartę {+2_WHITE} {MUDDLE}",
            "Dodaj dwie karty {AGAIN} {HEAL}1",
            "Zignoruj negatywne efekty przedmiotu oraz dodaj jedną kartę {+1_WHITE}",
            "Zignoruj negatywne efekty scenariusza i dodaj jedną kartę {+1_WHITE}"
    ...
    "DR": {
        ...
        "perks": [
            "Usuń dwie karty {-1_WHITE}",
            "Usuń jedną kartę {-2_WHITE}",
            "Zastąp dwie karty {+1_WHITE} jedną kartą {+3_WHITE} {SHIELD}1, na siebie",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {SHIELD}1, na sojusznika",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {DARK}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {LIGHT}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+3_WHITE} {MUDDLE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {CURSE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {REGENERATE}, na siebie",
    ...
    "RG": {
        "name": "Czerwony Strażnik",
        "perks": [
            "Usuń cztery karty {+0_WHITE}",
            "Usuń dwie karty {-1_WHITE}",
            "Usuń jedną kartę {-2_WHITE} oraz jedną kartę {+1_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE}",
            "Zastąp jedną kartę {+1_WHITE} jedną kartą {+2_WHITE} {FIRE}",
            "Zastąp jedną kartę {+1_WHITE} jedną kartą {+2_WHITE} {LIGHT}",
    ...
    "DM": {
        ...
        "perks": [
            ...
            "Usuń dwie karty {-1_WHITE}",
            "Usuń jedną kartę {-2_WHITE} oraz jedną kartę {+1_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {MUDDLE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {POISON}",
            "Dodaj jedną kartę {+2_WHITE}",
    ...
    "HT": {
        ...
        "perks": [
            "Usuń dwie karty {-1_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE} {MUDDLE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {POISON}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {WOUND}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {IMMOBILIZE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {PUSH}2",
    ...
    "VW": {
        ...
        "perks": [
            ...
            "Usuń jedną kartę {-2_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {DARK}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {ICE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {HEAL}1 (Sojusznik)",
    ...
    "AA": {
        "name": "Amber Aegis",
        "perks": [
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {-1_WHITE} “Place one {COLONY} {COLONY_ICON} token of your choice on any empty hex within {RANGE}2”",
            "Usuń dwie karty {-1_WHITE}",
            "Usuń cztery karty {+0_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+2_WHITE} {MUDDLE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE} {POISON}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE} {WOUND}",
            "Dodaj dwie karty {AGAIN} {+1_WHITE} {IMMOBILIZE}",
            "Dodaj jedną kartę {AGAIN} {HEAL}3, na siebie i jedną kartę {SHIELD}1, na siebie",
            "Dodaj jedną kartę {AGAIN} {RETALIATE}1, {RANGE}3",
            "Dodaj jedną kartę {+2_WHITE} {EARTH_FIRE}",
            "Zignoruj negatywne efekty przedmiotu oraz dodaj jedną kartę {+1_WHITE}",
            "Zignoruj negatywne efekty scenariusza i dodaj jedną kartę “{+X_WHITE}, where X is the number of active {CULTIVATE} {AA_CIRCLE} actions”"
        ]
    },
    "QA": {
        "name": "Artificer",
        "perks": [
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {-1_WHITE} {ANY}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE} {DISARM}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE} {PUSH}1",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE} {PULL}1",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+0_WHITE} {REFRESH} a spent item",
    ...
    "BM": {
        ...
        "perks": [
            ...
            "Zastąp jedną kartę {+1_WHITE} dwiema kartami {+1_WHITE} “{RELALIATE}1 {RANGE}3”",
            ...
            "Dodaj dwie karty {AGAIN} “{SHIELD}1, na siebie”",
            "Dodaj dwie karty {AGAIN} “{HEAL}1, na siebie”",
            "Zignoruj negatywne efekty scenariusza i usuń jedną kartę {+0_WHITE}",
            "Zignoruj negatywne efekty przedmiotu oraz Usuń jedną kartę {+0_WHITE}"
        ]
    },
    "BK": {
        "name": "Brightspark",
        "perks": [
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} “{ANY_X} to add +2 {ATTACK}”",
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {-2_WHITE} “{RECOVER} one random card from your discard pile”",
            "Zastąp dwie karty {+0_WHITE} jedną kartą {+1_WHITE} “{HEAL}1, (Sojusznik) {RANGE}2”",
            "Zastąp dwie karty {+0_WHITE} jedną kartą {+1_WHITE} “{SHIELD}1, (Sojusznik) {RANGE}2”",
            "Zastąp jedną kartę {+1_WHITE} jedną kartą {+2_WHITE} {ANY}",
            "Dodaj jedną kartę {+1_WHITE} “{STRENGTHEN} (Sojusznik) {RANGE}2”",
            "Dodaj jedną kartę {AGAIN} “{PUSH}1 or {PULL}1, {WIND}” oraz jedną kartę {AGAIN} “{IMMOBILIZE}, {ICE}”",
            "Dodaj jedną kartę {AGAIN} “{HEAL}1, {RANGE}3, {ICE}” oraz jedną kartę {AGAIN} “{PIERCE}2, {FIRE}”",
            "Dodaj trzy karty {AGAIN} “{ANY_X}:{ANY}”",
    ...
    "CG": {
        "name": "Chainguard",
        "perks": [
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE} “{SHACKLE} {CG_CIRCLE}”",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} “{+2_WHITE} if the target is {SHACKLED} {CG_CIRCLE}”",
            "Zastąp dwie karty {+0_WHITE} jedną kartą {AGAIN} “{SHIELD}1, na siebie”",
            "Dodaj dwie karty {AGAIN} “{RETALIATE}1, na siebie”",
            "Dodaj trzy karty {AGAIN} {SWING}3",
            "Zastąp jedną kartę {+1_WHITE} jedną kartą {+2_WHITE} {WOUND}",
            "Dodaj jedną kartę {+1_WHITE} “{DISARM} if the target is {SHACKLED} {CG_CIRCLE}”",
            "Dodaj jedną kartę {+1_WHITE} “Create a 2 damage trap in an empty hex within {RANGE}2”",
            "Dodaj dwie karty {AGAIN} “{HEAL}1, na siebie”",
            "Dodaj jedną kartę {+2_WHITE} “{SHACKLE} {CG_CIRCLE}”",
            "Zignoruj negatywne efekty scenariusza i usuń jedną kartę {+0_WHITE}"
        ]
    },
    "CT": {
        ...
        "perks": [
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {POISON}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} “{HEAL}1, {CT}”",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} “{HEAL}1, all summoned allies owned”",
    ...
    "FK": {
        ...
        "perks": [
            "Usuń dwie karty {-1_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} “{STRENGTHEN} (Sojusznik)”",
            "Zastąp dwie karty {+0_WHITE} dwiema kartami {+0_WHITE} “{+2_WHITE} if you are on {LADDER} {FK_CIRCLE}”",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {FIRE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {WOUND}",
            "Zastąp dwie karty {+1_WHITE} jedną kartą {+2_WHITE} {FIRE}",
            "Zastąp dwie karty {+1_WHITE} jedną kartą {+2_WHITE} {WOUND}",
            "Dodaj jedną kartę {+1_WHITE} “{STRENGTHEN} (Sojusznik)”",
            "Dodaj dwie karty {AGAIN} “{HEAL}1, {RANGE}1”",
            "Dodaj dwie karty {AGAIN} {WOUND}",
            "Zignoruj negatywne efekty przedmiotu oraz dodaj jedną kartę {AGAIN} {FIRE}",
            "Zignoruj negatywne efekty scenariusza i dodaj jedną kartę {AGAIN} {FIRE}"
        ]
    },
    "HP": {
        "name": "Hierophant",
        "perks": [
            "Usuń dwie karty {-1_WHITE}",
            "Zastąp dwie karty {+0_WHITE} jedną kartą {AGAIN} {LIGHT}",
    ...
    "HO": {
        "name": "Hollowpact",
        "perks": [
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} “{HEAL}2, na siebie”",
            "Zastąp dwie karty {+0_WHITE} jedną kartą {+0_WHITE} “{VOIDSIGHT} {VOIDSIGHT_ICON}”",
            "Dodaj jedną kartę {-2_WHITE} {EARTH} oraz dwie karty {+2_WHITE} {DARK}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {-2_WHITE} {STUN} i jedną kartę {+0_WHITE} “{VOIDSIGHT} {VOIDSIGHT_ICON}”",
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {+0_WHITE} {DISARM} oraz jedną kartę {-1_WHITE} {ANY}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {AGAIN} {+1_WHITE} “{HO_CIRCLE} i jedną kartę {AGAIN} {-1_WHITE} {CURSE}”",
            "Zastąp dwie karty {+1_WHITE} jedną kartą {+3_WHITE} “{REGENERATE}, na siebie”",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} “Create a Void pit in an empty hex {RANGE}2”",
            "Zignoruj negatywne efekty scenariusza i dodaj jedną kartę {+0_WHITE} “{WARD}, na siebie”"
        ]
    },
    "LU": {
        "name": "Luminary",
        "perks": [
            "Usuń cztery karty {+0_WHITE}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+2_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {ICE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {FIRE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {LIGHT}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {DARK}",
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {-2_WHITE} “Perform one {GLOW} {LU_CIRCLE} ability”",
            "Dodaj jedną kartę {+0_WHITE} {ANY}",
            "Dodaj jedną kartę {AGAIN} {+1_WHITE} “{HEAL}1, na siebie”",
            "TODO:: Dodaj jedną kartę {+0_WHITE} “{POISON}, Target all  enemies in the depicted {AOE.CLEAVE_0_1} area”",
            "Zignoruj negatywne efekty scenariusza i usuń jedną kartę {+0_WHITE}",
            "Zignoruj negatywne efekty przedmiotu oraz dodaj jedną kartę {AGAIN} “{ANY_X}:{ANY}”"
        ]
    },
    "MF": {
        "name": "Mirefoot",
        "perks": [
            ...
            "Gain “Poison Dagger” (Item 011). You may carry one additional {ONE-HAND} item with “Dagger” in its name",
            "Ignore damage, and negative conditions and modifiers from Events, and Usuń jedną kartę {-1_WHITE}",
            "Zignoruj negatywne efekty scenariusza i usuń jedną kartę {-1_WHITE}"
        ]
    },
    "RM": {
        "name": "Ruinmaw",
        "perks": [
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {-1_WHITE} {RUPTURE} and {WOUND}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} {WOUND}",
    ...
    "SP": {
        "name": "Spirit Caller",
        "perks": [
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {-1_WHITE} oraz jedną kartę {+1_WHITE}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} “{+2_WHITE} if a {SPIRIT} {SP_CIRCLE} performed the attack”",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+0_WHITE} oraz jedną kartę {AGAIN} {POISON}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {WIND}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {DARK}",
            "Zastąp jedną kartę {+0_WHITE} jedną kartą {+1_WHITE} {PIERCE}2",
            "Dodaj trzy karty {AGAIN} {PIERCE}3",
            "Dodaj jedną kartę {+1_WHITE} {CURSE}",
            "Dodaj jedną kartę {AGAIN} ADD {TARGET}",
            "Zastąp jedną kartę {+1_WHITE} jedną kartą {+2_WHITE} {PUSH}2",
            "Zignoruj negatywne efekty scenariusza i usuń jedną kartę {+0_WHITE}"
        ]
    },
    "ST": {
        "name": "Starslinger",
        "perks": [
            "Zastąp dwie karty {+0_WHITE} jedną kartą {AGAIN} “{HEAL}1, na siebie”",
            "Zastąp jedną kartę {-2_WHITE} jedną kartą {-1_WHITE} {DISARM} oraz jedną kartę {-1_WHITE} “{INVISIBLE}, na siebie”",
            "Zastąp dwie karty {-1_WHITE} jedną kartą {+0_WHITE} {DARK}",
            "Zastąp jedną kartę {-1_WHITE} jedną kartą {+1_WHITE} {LIGHT}",
            "Dodaj jedną kartę {AGAIN} “{LOOT 1}”",
            "Dodaj jedną kartę {+1_WHITE} “{+3_WHITE} if you are at full health”",
            "Dodaj dwie karty {AGAIN} {IMMOBILIZE}",
            "Dodaj jedną kartę {+1_WHITE} “{HEAL}1 {RANGE}3”",
            "Dodaj dwie karty {AGAIN} “Force the target to perform `{MOVE}1`”",
            "Dodaj jedną kartę {AGAIN} “{HEAL}1 {RANGE}1”",
            "Zignoruj negatywne efekty scenariusza i usuń jedną kartę {+0_WHITE}"
        ]
    },
    "DF": {
