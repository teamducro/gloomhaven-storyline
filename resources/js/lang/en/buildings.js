export default {
    ...
    "fh-24": {
        ...
        "levels": [
            ...
            {
                "level": 3,
                "operations": "Gain 1 collective herb from each planted plot, then plant herbs",
                "downtime": "",
                "wrecked": "",
                "passive": "",
                "rewards": "+1 prosperity",
    ...
    "fh-42": {
        ...
        "levels": [
            ...
            {
                "level": 1,
                "operations": "Each character may lose 5 gold to start the next scenario with {BLESS.img}x2",
                "downtime": "",
                "wrecked": "Each character starts the next scenario with {CURSE.img}",
                "passive": "",
    ...
    "fh-44": {
        ...
        "levels": [
            ...
            },
            {
                ...
                "wrecked": "Each character starts the next scenario with {DISARM.img}",
                "passive": "",
    ...
    "fh-98": {
        ...
        "levels": [
            ...
            },
            {
                ...
                "passive": "Capacity: 4, Effect: advantage and -5{ATTACK.img}",
                "rewards": "+1 prosperity",
            },
            {
                "level": 2,
                ...
                "downtime": "",
                "wrecked": "Disadvantage on all attack event resolutions. Cannot use soldiers.",
                "passive": "Capacity: 6, Effect: advantage and -15{ATTACK.img}",
            ...
            },
            {
                ...
                "downtime": "",
                "wrecked": "Disadvantage on all attack event resolutions. Cannot use soldiers.",
                "passive": "Capacity: 8, Effect: advantage and -25{ATTACK.img}",
                "rewards": "+1 prosperity, +2 soldiers",
            },
            {
                "level": 4,
                ...
                "downtime": "",
                "wrecked": "Disadvantage on all attack event resolutions. Cannot use soldiers.",
                "passive": "Capacity: 10, Effect: advantage and -35{ATTACK.img}",
                "rewards": "+1 prosperity, +2 soldiers",
            }
        ]
    }
