export default {
    ...
    "gh-11": {
        ...
        "rewards": [
            ...
            "-2 к репутации",
            "+2 к процветанию",
            "Чертёж «Топора порчи черепов» (Предмет 113)"
        ]
    },
    "gh-12": {
    ...
    "gh-21": {
        ...
        "rewards": [
            ...
            "+1 к процветанию",
            "Добавьте в колоду «Город» карту события 78"
        ]
    },
    "gh-22": {
        "name": "Храм стихий"
    ...
    "gh-25": {
        "name": "Восхождение на Ледяной утёс"
    },
    "gh-26": {
    ...
    "gh-27": {
        ...
        "rewards": [
            "+1 к процветанию",
            "Все получают по 100 золотых (эти деньги нужно немедленно потратить на улучшения, добавив при желании деньги из личного запаса)"
        ]
    },
    "gh-28": {
        "name": "Внешнее капище"
    ...
    "gh-29": {
        "name": "Обитель Мрака",
        "rewards": [
            "Все получают по 15 очков опыта"
        ]
    },
    "gh-30": {
    ...
    "gh-35": {
        ...
        "rewards": [
            "Все получают по 30 золотых",
            "5 к репутации",
            "-2 к процветанию",
            "Добавьте в колоду «Город» карту события 79"
        ]
    },
    "gh-36": {
    ...
    "gh-41": {
        ...
        "rewards": [
            "Все получают по 50 золотых",
            "Все получают по 25 очков опыта",
            "Все получают по 2 ✔",
            "+2 к процветанию"
        ]
    },
    ...
    "gh-44": {
        ...
        "rewards": [
            "Откройте коробочки {DS}",
            "+2 к репутации"
        ]
    },
    "gh-45": {
        "name": "Привал болотных повстанцев",
        "rewards": [
            "Все получают по 20 золотых",
            "-2 к репутации"
        ]
    ...
    "gh-51": {
        ...
        "rewards": [
            "+5 к репутации",
            "+5 к процветанию",
            "Добавьте в колоду «Город» карту события 81",
            "Добавьте в колоду «Дорога» карту события 69"
        ]
    },
    "gh-52": {
        "name": "Жуткий погреб"
    ...
    "gh-53": {
        "name": "Подвал склепа",
        "rewards": [
            "Последователь Зорна получает «Посох Зорна» (предмет 114). Он не может продать этот предмет."
        ]
    },
    "gh-54": {
        "name": "Ледяной дворец",
        "rewards": [
            "Личное задание «Последователь Зорна» выполнено",
            "Последователь Зорна немедленно отправляется на покой",
            "Добавьте в колоды «Город» и «Дорога» по карте события 59 вместо обычных действий при уходе класса на покой",
            "Откройте коробочки {PH}"
        ]
    },
    "gh-55": {
    ...
    "gh-56": {
        ...
        "rewards": [
            "Личное задание «Возвращение леса» выполнено",
            "Откройте коробочки {DS}",
            "Все получают по 10 золотых",
            "+2 к репутации"
        ]
    ...
    "gh-58": {
        ...
        "rewards": [
            "Личное задание «Месть» выполнено",
            "Откройте конверт В",
            "+2 к репутации"
        ]
    },
    ...
    "gh-60": {
        "name": "Алхемическая лаборатория",
        "rewards": [
            "Личное задание «В поисках лекартсва» выполнено",
            "Откройте конверт В",
            "+1 к процветанию"
        ]
    },
    ...
    "gh-62": {
        "name": "Колодец душ",
        "rewards": [
            "Личное задание «Грехопадение» выполнено",
            "Откройте коробочки {NS}",
    ...
    "gh-65": {
        "name": "Серная шахта",
        "rewards": [
            "Чертёж «Древнего бура» (предмет 112)"
        ]
    },
    "gh-66": {
    ...
    "gh-67": {
        ...
        "rewards": [
            "«Энергетическое ядро» (предмет 132)"
        ]
    },
    "gh-68": {
        "name": "Ядовитая трясина",
        "rewards": [
            "2 «Больших зелья лечения» (предмет 027)"
        ]
    },
    "gh-69": {
    ...
    "gh-71": {
        ...
        "rewards": [
            "2 «Больших зелья силы» (предмет 041)"
        ]
    },
    "gh-72": {
        "name": "Скользкая роща",
    ...
    "gh-84": {
        ...
        "rewards": [
            "«Резонирующий кристалл» (предмет 133)",
            "+1 к процветанию"
        ]
    },
    "gh-85": {
    ...
    "fc-102": {
        ...
        "rewards": [
            "15 experience each",
            "If no more than 2+C inhabitants were intimidated: +2 к репутации Otherwise: -2 к репутации"
        ]
    },
    "fc-103": {
    ...
    "fc-106": {
        ...
        "rewards": [
            [
                "17Все получают по 5 золотых, This money must immediately be spent on any {WIND}, {ICE}, {FIRE}, {EARTH}, {LIGHT}, or {DARK} enhancements"
            ],
            [
                "17Все получают по 5 золотых, This money must immediately be spent on any {WIND}, {ICE}, {FIRE}, {EARTH}, {LIGHT}, or {DARK} enhancements",
                "+ 1 к процветанию"
