export default {
    ...
    "quest-fc": {
        "96": {
            "sections": {
                "1": "Tu grupo sobrevivió a la Calamidad, pero aún quedan muchos misterios por resolver. Las últimas palabras pronunciadas por el Vacío resuenan en tu cabeza y Hail se niega a hablar de lo sucedido. Solo sabes que el nombre de la criatura alguna vez fue Bastian, pero alguien o algo lo estaba usando como receptáculo; nada más. \nLas ruinas del campo de batalla ahora están bloqueadas por un grupo de humanos militantes que aparentemente están estudiando el área, financiado por la finca Deslin. Simplemente sabes que algo anda mal con ellos. Como todo esto no fue suficiente, tus heridas parecen sanar misteriosamente más lentamente de lo normal. Todo se siente extraño e incorrecto, tanto en tu cuerpo como en tu espíritu, y te sientes marcado por las armas de los enemigos y por las pesadillas que te persiguen. ¿Quizás beber y apostar finalmente te curará? Regresas al León Durmiente, donde te tratan como héroes. De repente, se abre un desgarro en el tejido de la realidad y Demons entra en la taberna, seguido inmediatamente por una mujer Aesther, que pide tu ayuda. Seguro que tus pesadillas aún no han terminado.",
