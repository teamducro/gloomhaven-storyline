export default {
    ...
    "quest-fc": {
        "96": {
            "sections": {
                "1": "Tu grupo sobrevivió a la Calamidad, pero aún quedan muchos misterios por resolver. Las últimas palabras pronunciadas por el Vacío resuenan en tu cabeza y Hail se niega a hablar de lo sucedido. Solo sabes que el nombre de la criatura alguna vez fue Bastian, pero alguien o algo lo estaba usando como receptáculo;. \nLas ruinas descubiertas bajo el Vacío ahora están bloqueadas por un grupo de humanos militantes financiados por la familia Deslin, acordonando el área para su estudio privado. Está claro que es obra de la Vigilia, por le momento poco más podéis hacer. Como si todo esto no fuera suficiente, las heridas de vustras batallas no terminan de cerrarse y sanan mucho más lento de lo que deberían. Todo se siente extraño e incorrecto, tanto en vuestro cuerpo como en vuestro espíritu, y os sentis marcados por las armas de los enemigos y por las pesadillas que os persiguen. Decidís que beber y los juegos de azar os ayuden a acallar los recuerdos del pasado y los malos presagios del futuro. Regresáis al León Durmiente, donde os tratan como héroes. De repente, se abre una brecha en el tejido de la realidad por la que aparece una etérida maltrecha, que os pide vuestra ayuda, seguida por unos demonios de viento. Todos menos vosotros huyen de la escena mientras otros tipos de demonios se cuelan por la brecha. Si no estabáis lo suficiente enfadados por que os interrumpiesen en vustra noche libre, ahora con vuestro equipo en mano, lo estáis realmente.",
                "2": "Destruis todos los altares y volvéis corriendo a vuestro plano de realidad, mientras que la misteriosa etérida repara las fisuras que habéis cerrado. Ella os dice que fue encarcelada con los demonios y logró escapar gracias a la derrota de la Penumbra. Ella parece saber mucho sobre la historia de los etéridos y menciona que el Vacío fue una vez el sitio de una gran torre que Bastian construyó para albergar investigadores y estudios. Cuando la Penumbra comenzó la Catástrofe, la Torre y todos sus habitantes se dispersaron por el infinito entre los planos. Los que sobrevivieron se convirtieron en los etéridos, eternos y sin hogar. Tras seguirla a través de una fisura planar, se presenta como Cassandra, una viajera a través de realidades que trató de detener a la Penumbra hace siglos junto con otros, pero lamentablemente fracasaron y ha sido prisionera desde entonces, condenada a ver cómo el plan de la corrupción sin poder hacer nada. Cassandra pide nuestra ayuda para detener a la Penumbra de una vez por todas, primero debéis ir al Vacío y encontrar la vasta biblioteca de textos de Bastian, que alguna vez formó parte de la Torre aunque la Vigilia tiene acordonada la zona de acceso. Cassandra puede tener otros medios para llegar..."
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}"
        ...
        "97": {
            "sections": {
                "1": "Cassandra os enseña un boceto de la Bóveda del Saber, donde están escondidos los cuatro pergaminos que necesita. Ella levanta las manos y abre un portal al salón central de la Bóveda, alertándoos sobre las trampas que seguramente encontraréis allí.",
                "2": "Una vez que todos los pergaminos hayan sido rescatados y estén en vustras manos, Cassandra los llevará a todos de regreso a su santuario y comenzará a estudiar lo que tienes. Ella parece caer en un trance profundo mientras examina los documentos, a veces pronunciando crípticas palabras. Cuando vuelve en sí, parece molesta por todo el trabajo que queda por hacer. Cada uno de los pergaminos lleva a un camino diferente y todos deben explorarse antes de sacar conclusiones. Cassandra os entrega un papel misterioso con algo escrito por Bastian en un idioma que nunca habéis visto."
            },
            "stages": {
                "0": "{1}",
                "1": "{1}{2}"
