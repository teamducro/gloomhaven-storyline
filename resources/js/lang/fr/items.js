export default {
    ...
    "gh-107": {
        ...
        "faq": "Ce bonus doit être utilisé durant le tour où il est gagné. Il ne peut pas être conservé. Si vous utilisez plusieurs capacités de déplacement, vous pouvez utiliser l'objet si vous vous êtes déplacé d'au moins 4 hexagone au total. Cet objet peut être utilisé uniquement une fois pas tour même si vous vous déplacez plusieurs fois de 4 hexagones durant votre tour."
    },
    "gh-108": {
    ...
    "gh-115": {
        ...
        "faq": "Cette carte est traitée comme un bonus persistant, se plaçant dans la zone active jusqu'à ce que l'Esprit Guerrier soit tué ou que la carte soit consommée. Si la carte est rafraîchie, et qu'il existe un Esprit Guerrier actif, l'Esprit Guerrier disparais."
    },
    "gh-116": {
        "name": "Fauchon Attisé",
